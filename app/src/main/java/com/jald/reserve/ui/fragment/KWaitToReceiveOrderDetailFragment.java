...
import com.jald.reserve.adapter.KWaitToReceiveOrderCommodyListAdapter;
import com.jald.reserve.bean.http.response.KWaitToReceiveOrderListResponseBean;

import org.xutils.view.annotation.ViewInject;
import org.xutils.x;

public class KWaitToReceiveOrderDetailFragment extends Fragment {
    ...
    private KWaitToReceiveOrderCommodyListAdapter adapter;

    private KWaitToReceiveOrderListResponseBean.KWaitToReceiveOrderItem orderItem;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.orderItem = (KWaitToReceiveOrderListResponseBean.KWaitToReceiveOrderItem) getArguments().getSerializable(ARG_KEY_ORDER_ITEM);
        ...
        this.adapter = new KWaitToReceiveOrderCommodyListAdapter(getActivity());
