...
public class FuturesDetailListAdapter extends BaseAdapter {
    ...
    public FuturesDetailListAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.futures_detail_list_item, parent, false);
        final FuturesDetailListAdapter.ViewHolder holder = new FuturesDetailListAdapter.ViewHolder(convertView);
        ...
        holder.tvSum.setText("" + (max - progress));//剩余数量
