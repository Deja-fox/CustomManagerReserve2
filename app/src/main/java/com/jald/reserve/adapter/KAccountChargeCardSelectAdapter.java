...
public class KAccountChargeCardSelectAdapter extends BaseAdapter {

    private Context context;
    private LayoutInflater inflater;
    private List<KBankCardItemBean> cardList = new ArrayList<KBankCardItemBean>();

    public KAccountChargeCardSelectAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.k_charge_card_select_listview_item, parent, false);
