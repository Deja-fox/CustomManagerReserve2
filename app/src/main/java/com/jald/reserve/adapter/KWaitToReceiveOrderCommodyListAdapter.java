...
public class KWaitToReceiveOrderCommodyListAdapter extends BaseAdapter {

    private LayoutInflater inflater;
    private List<KWaitToReceiveOrderListResponseBean.KWaitToReceiveOrderCommodityItem> commdyList;

    public KWaitToReceiveOrderCommodyListAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        KWaitToReceiveOrderListResponseBean.KWaitToReceiveOrderCommodityItem item = commdyList.get(position);
    ...
    public void setItemsList(List<KWaitToReceiveOrderListResponseBean.KWaitToReceiveOrderCommodityItem> itemsList) {
