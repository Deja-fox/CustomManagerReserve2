...
public class ExtendedRefreshableListViewWrapper extends LinearLayout implements ExtendedRefreshableListView.OnGesterListener {
    ...
    private ExtendedRefreshableListView mListView;
    ...
    public ExtendedRefreshableListViewWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initHeaderViewAndFooterViewAndListView(context);
    }

    public ExtendedRefreshableListViewWrapper(Context context) {
        super(context);
        mContext = context;
        initHeaderViewAndFooterViewAndListView(context);
    }
    ...
    private void initHeaderViewAndFooterViewAndListView(Context context) {
        ...
        mListView = new ExtendedRefreshableListView(context);
    ...
    public boolean onListViewBottomAndPullUp(int delta) {
        if (!mConfig.isEnableAutoFetchMore() || mIsFetchMoreing || mIsLoadMoreClosed) return false;
        if (isFillScreenItem()) {
            mIsFetchMoreing = true;
    ...
    public boolean onMotionUp(MotionEvent ev) {
        @SuppressWarnings("unused") final int y = (int) ev.getRawY();
    ...
    private boolean isFillScreenItem() {
        ...
        if (visibleItemCount < totalItemCountInAdapter) return true;
        else return false;
    }
    ...
    public static class Config {
        ...
        public static class Build {
            ...
            private void initDefaultValue() {
                ...
                this.dividerHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (float) 1.0, context.getResources().getDisplayMetrics());
