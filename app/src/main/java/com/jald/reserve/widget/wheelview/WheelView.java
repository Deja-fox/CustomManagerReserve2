...
package com.jald.reserve.widget.wheelview;
...
import com.jald.reserve.widget.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	/*
	 * / Modified by wulianghuan 2014-11-25 private int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA }; //
	 */
	...
	private void drawShadows(Canvas canvas) {
		/*
		 * / Modified by wulianghuan 2014-11-25 int height = (int)(1.5 * getItemHeight()); //
		 */
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / Remarked by wulianghuan 2014-11-27 使用自己的画线，而不是描边 Rect rect = new Rect(left, top, right, bottom) centerDrawable.setBounds(bounds)
		 * centerDrawable.setBounds(0, center - offset, getWidth(), center + offset); centerDrawable.draw(canvas); //
		 */
